...
//query for reginfo
$reginfoquery = pg_query_params($surestore_db, "select sureorders.orderid, sureorders.orderwh, sureorders.weight, sureorders.ordertype, sureorders.valtype, sureorders.orderval, sureorders.sitnum, sureorders.sitex from sureorders where sureorders.orderid=$1", array($orderid));
