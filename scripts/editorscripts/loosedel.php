...
//delete query 
$deletequery = pg_query_params($surestore_db, "DELETE FROM sureloose where looseid = $1", array($looseid));

// assign result to array
$deletequeryresult = pg_fetch_assoc($deletequery);

// log in history table
$updatetext = $userid." deleted loose ".$looseid.".";
