			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="form-group" id="regweight">
						...
						<small id="regweightHelp" class="form-text text-muted">Weight - LBS (Required)</small>
					</div>
				</div>
			</div>
		...
		<form action="/scripts/php/updatecustinfo.php" id="custinfoform">
			...
			<div  class="row">
				<div class="form-group my-1" id="custid">
					...
					<small id="custidHelp" class="form-text text-muted">Customer Search</small>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col">
					<!-- Business Name -->
					<div class="form-group mb-1" id="custbusiness">
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="form-group mb-1" id="custaddy">
						<input type="input" class="form-control shadow-sm" id="custaddyinput" required>
				...
				<div class="col">
					...
					<div class="form-group mb-1" id="regcity">
						<input type="input" class="form-control shadow-sm" id="custcityinput" required>
				...
				<div class="col">
					...
					<div class="form-group mb-1" id="custstate">
						<select class="form-control shadow-sm" id="custstateinput" name="custstateinput">
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="form-group mb-1" id="custzip">
						<input type="input" class="form-control shadow-sm" id="custzipinput" required>
				...
				<div class="col">
					...
					<div class="form-group mb-1" id="custcountry">
						<select class="form-control shadow-sm" id="custcountryinput" name="custcountryinput" required>
