...
<div class="row" id="rowmain">
	...
	<!-- Left column -->
	<div class="col-lg-4 order-3 order-lg-1" id="left"></div>

	<!-- Middle column -->
	<div class="col-lg-4 order-2 order-lg-2" id="middle"></div>

	<!-- Right column -->
	<div class="col-lg-4 order-1 order-lg-3" id="right"></div>
</div>
